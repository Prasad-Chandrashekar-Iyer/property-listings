                        ...
                        @forelse ($properties as $property)
                            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300 group">
                                <a href="{{ route('dashboard.properties.show', $property) }}" class="block">
                                    <div class="relative">
                                        <img src="{{ $property->image ? asset('storage/' . $property->image) : asset('sample.jpeg') }}" alt="{{ $property->title }}" class="w-full h-56 object-cover group-hover:scale-105 transition-transform duration-500">
