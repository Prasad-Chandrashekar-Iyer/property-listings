            ...
            <form action="{{ route('admin.properties.update', $property) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" 
                        ...
                        value="{{ old('title', $property->title) }}" required placeholder="e.g. Modern Apartment in City Center">
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="5" 
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5 px-3 border" 
                        required placeholder="Describe the property features...">{{ old('description', $property->description) }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input type="number" step="0.01" name="price" id="price" 
                                ...
                                value="{{ old('price', $property->price) }}" required placeholder="0.00">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="location" id="location" 
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5 px-3 border" 
                            value="{{ old('location', $property->location) }}" required placeholder="e.g. New York, NY">
                    </div>
                ...
                <div class="border-t border-gray-100 pt-6">
                    ...
                    <div class="flex items-start gap-6">
                        @if ($property->image)
                            <div class="w-32 h-32 rounded-lg border border-gray-200 overflow-hidden bg-gray-50 flex-shrink-0 relative group">
                                <img src="{{ asset('storage/' . $property->image) }}" alt="Current Image" class="w-full h-full object-cover">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="mt-2 text-xs text-gray-500">
                                ...
                                @else
                                    Upload a high-quality image of the property (JPG, PNG).
                                @endif
                            </p>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-100">
                    <a href="{{ route('admin.properties.index') }}" class="px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition">
                        Cancel
                    </a>
